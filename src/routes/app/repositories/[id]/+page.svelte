...
<div>
  <h2 class="text-2xl font-bold mb-6 text-primary">Pull Requests for {$selectedRepository ? $selectedRepository.name : 'Loading...'}</h2>
      ...
      {#each pullRequests as pr}
        <a 
          ...
          <Item 
            ...
            <span class="text-gray-700">Updated at <Time timestamp={pr.updated_at} format="dddd @ h:mm A · MMMM D, YYYY"/>
          </Item>
        </a>
      {/each}
    {:else}
